...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setCameraAutoExposureState  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getExposureMode  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setSpotMeteringArea  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getSpotMeteringArea  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getExposure  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setExposure  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getISO  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setISO  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getIRIS  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setIRIS  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getShutter  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setShutter  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getAspectRatio  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setAspectRatio  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setPhotoFormat  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getPhotoFormat  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getWhiteBalance  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setWhiteBalance  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setColorStyle  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getVideoResolutionAndFps  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setVideoResolutionAndFrameRate  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getVideoStandard  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setVideoStandard  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setVideoSubtitleEnable  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "is3DDenoiseEnable  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "set3DNoiseReductionEnable  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getAntiFlicker  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setAntiFlicker  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setPhotoStyle  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "startTakePhoto  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "stopRecordVideo  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "formatSDCard  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "resetDefaults  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getCurrentRecordTimeSeconds  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "startTakePhotoWithFocus  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setFocusMode  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setDigitalZoomScale  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "setConnectStateListener  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getDigitalZoomScale  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getAutoExposureLockState  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
//                logOut(handler, "getDigitalZoomScale  error: is not suppoert for xb004");
//            } else if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.XB008){
...
//    }
//
//    public static void getWorkStatus(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getWorkStatus  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
//                AModuleCamera.cameraManager().getXb004().getWorkStatus(new CallbackWithOneParam<CameraWorkState>() {
//                    @Override
...
//                });
//            } else if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().getWorkStatus(new CallbackWithOneParam<CameraWorkState>() {
//                    @Override
//                    public void onSuccess(CameraWorkState data) {
//                        logOut(handler, "getWorkStatus " + data);
//                    }
...
//                });
//            }else{
//                logOut(handler, "getWorkStatus  description  camera type is not clear");
//            }
//        }
//    }
//
//    public static void getSDCardStatus(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getSDCardStatus  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
//                AModuleCamera.cameraManager().getXb004().getSDCardStatus(new CallbackWithOneParam<SDCardState>() {
//                    @Override
...
//                });
//            } else if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().getSDCardStatus(new CallbackWithOneParam<SDCardState>() {
//                    @Override
//                    public void onSuccess(SDCardState data) {
//                        logOut(handler, "getSDCardStatus " + data);
//                    }
...
//                });
//            }else{
//                logOut(handler, "getSDCardStatus  description  camera type is not clear");
//            }
//        }
//    }
//
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getMediaMode  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getVideoSum  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//    }
//
//    public static void getPhotoSum(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getPhotoSum  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
//                AModuleCamera.cameraManager().getXb004().getPhotoSum(new CallbackWithOneParam<PhotoSum>() {
//                    @Override
...
//                });
//            } else if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().getPhotoSum(new CallbackWithOneParam<PhotoSum>() {
//                    @Override
//                    public void onSuccess(PhotoSum data) {
//                        logOut(handler, "getPhotoSum " + data);
//                    }
...
//                });
//            }else{
//                logOut(handler, "getPhotoSum  description  camera type is not clear");
//            }
//        }
//
//    }
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getSDCardFreeSpace  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getNickName  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "isSubtitleSwitchEnable  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getTimeStamp  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getVideoFormat  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getBurstCount  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getPhotoTimelapseInterval  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getVersion  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//    }
//
//    public static void isHistogramStatusEnable(final Handler handler) {
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "isHistogramStatusEnable  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
//                AModuleCamera.cameraManager().getXb004().isHistogramStatusEnable(new CallbackWithOneParam<Boolean>() {
//                    @Override
//                    public void onSuccess(Boolean data) {
...
//                });
//            } else if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.XB008){
//                AModuleCamera.cameraManager().getXb008().isHistogramStatusEnable(new CallbackWithOneParam<Boolean>() {
//                    @Override
//                    public void onSuccess(Boolean data) {
//                        logOut(handler, "isHistogramStatusEnable " + data);
//                    }
...
//                });
//            }else{
//                logOut(handler, "isHistogramStatusEnable  description  camera type is not clear");
//            }
//        }
//    }
//
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getPhotoStyle  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getColorStyle  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
...
//        if (AModuleCamera.cameraManager().getParameterSupport().getError() != null) {
//            logOut(handler, "getFocusDistance  error: " + AModuleCamera.cameraManager().getParameterSupport().getError().getDescription());
//        } else {
//            if(AModuleCamera.cameraManager().getParameterSupport().getResult().getCurrentProduct() == CameraProduct.R12){
